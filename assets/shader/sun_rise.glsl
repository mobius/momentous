...
mat3 mRGB2XYZ = mat3(0.5141364, 0.3238786 , 0.16036376,
				     0.265068 , 0.67023428, 0.06409157,
					 0.0241188, 0.1228178 , 0.84442666);

mat3 mXYZ2RGB = mat3( 2.5651, -1.1665, -0.3986,
...
{	
	...
	vec3 c_position = vec3(0.0, 0.1, 1.4);
	...
	sun.alt = -0.1 + 1.2 * PI_4 * (0.5 + cos(0.38 * iGlobalTime) / 2.0);
